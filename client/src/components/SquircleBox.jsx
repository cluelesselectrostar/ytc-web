...
class SquircleBox extends Component {
    ...
    render() {
        if (this.props.appearance === "teal") {
            return (
                <div className="h-100 p-5 text-white rounded-3 " style={{ backgroundColor:'teal'}}>
            ...
            return (
                <div className="h-100 p-5 text-white rounded-3" style={{ backgroundColor: 'rgb(51,51,51)'}}>
                    <h2>{this.props.title}</h2>
                    <div>{this.props.content}</div>
                </div>
            );
